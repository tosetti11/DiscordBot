  ...
  client.once('ready', async () => {
    ...
    try {
      ...
      const part1 = [
        ...
        '**7.** Review the auto-filled fields. Make any corrections if needed.',
        '**8.** Hit **"Place Bet 🎰"** and your bet is posted to the channel!',
        '',
      ...
      const part2 = [
        ...
        '**6.** Optionally add a **Note** with your reasoning.',
        '**7.** Click **"Place Bet 🎰"** — done! Your bet card is posted to the channel for everyone to see.',
        '',
        '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        '',
        '## 🎰 Option 3 — Parlays',
