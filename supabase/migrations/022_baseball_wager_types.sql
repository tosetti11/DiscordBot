-- Add NRFI, YRFI, Double Chance, and Draw No Bet wager types
...
ALTER TABLE bets ADD CONSTRAINT bets_wager_type_check
  CHECK (wager_type IN ('moneyline', 'spread', 'total', 'team_total', 'prop', 'futures', 'nrfi', 'yrfi', 'double_chance', 'draw_no_bet'));
